...
CREATE TABLE `tbl_users` (
  ...
  `user_access` varchar(20) NOT NULL default 'Staff',
...
CREATE TABLE `tbl_order_products` (
  ...
  `notes` varchar(230) NULL,
  `ref_image` varchar(230) NULL,
  `product_date_added` date NOT NULL,
...
DROP TABLE IF EXISTS `tbl_order_images`;
CREATE TABLE `tbl_order_images` (
