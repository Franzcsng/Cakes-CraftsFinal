...
function create_new_user(){
    ...
    $access = $_POST['access'];
    $result = $user->new_user($email,$password,$lastname,$firstname, $access, $phone);
    if($result){
...
function update_user(){
    ...
    $result = $user->update_user($lastname,$firstname,$phone,$user_id);
    if($result){
        header('location: ../index.php?page=settings&subpage=profile&id='.$id);
    }
}
...
function change_user_status(){
    ...
    if($result){
        header('location: ../index.php?page=settings&subpage=profile&id='.$user_id);
    }
}
