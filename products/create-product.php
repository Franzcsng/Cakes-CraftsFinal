...
<div id="form-block-product">
    <form method="POST" onsubmit="return validateCreateProduct()" name="createproduct" action="processes/process.product.php?action=new_product">
...
<script>
  function validateCreateProduct(){
    ...
    let name = document.createproduct.productname.value;
    let price = document.createproduct.productprice.value;
    let desc = document.createproduct.productdesc.value;
